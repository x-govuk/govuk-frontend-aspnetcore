...
public class ShortTagNamesTests(ShortTagNamesTestsFixture fixture) : IClassFixture<ShortTagNamesTestsFixture>
{
    ...
    [InlineData("Table", "short", "long", ".govuk-table__cell")]
    ...
    public async Task ErrorSummary_MixingShortAndGovUkPrefixedTagNames_Throws()
    {
        ...
        Assert.Contains(
            "<error-summary-item> cannot be used alongside <govuk-error-summary-title>; " +
                "short tag names and govuk- prefixed tag names cannot be mixed.",
            await response.Content.ReadAsStringAsync());
    }
    ...
    public async Task Pagination_MixingShortAndGovUkPrefixedTagNames_Throws()
    {
        ...
        Assert.Contains(
            "<next> cannot be used alongside <govuk-pagination-item>; " +
                "short tag names and govuk- prefixed tag names cannot be mixed.",
            await response.Content.ReadAsStringAsync());
    }
...
public class ShortTagNamesTestsController : Controller
{
    ...
    [HttpGet("Pagination")]
    public IActionResult GetPagination() => View("Pagination", new ShortTagNamesTestsModel());
    ...
    [HttpGet("ErrorSummary")]
    public IActionResult GetErrorSummary() => View("ErrorSummary", new ShortTagNamesTestsModel());
    ...
    [HttpGet("Table")]
    public IActionResult GetTable() => View("Table", new ShortTagNamesTestsModel());

    [HttpGet("TableMixed")]
    public IActionResult GetTableMixed() => View("TableMixed", new ShortTagNamesTestsModel());
