...
public class CheckboxesContextTests
{
    ...
    public void OpenFieldset_AlreadyOpen_ThrowsInvalidOperationException()
    {
        ...
        context.OpenFieldset(new FormGroupFieldsetContext2(CheckboxesFieldsetTagHelper.TagName), new AttributeCollection());
    ...
    public void SetHint_AlreadyGotItemAddedWithShortTagName_ThrowsInvalidOperationExceptionNamingTheShortTagName()
    {
        ...
        context.AddItem(item, "checkboxes-item");
        ...
        // Assert
        Assert.IsType<InvalidOperationException>(ex);
        Assert.Equal("<hint> must be specified before <checkboxes-item>.", ex.Message);
    }
