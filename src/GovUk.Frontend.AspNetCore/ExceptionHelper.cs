...
internal static class ExceptionHelper
{
    ...
    public static InvalidOperationException AChildElementMustBeProvided(IReadOnlyCollection<string> childElementTagNames) =>
    ...
    public static InvalidOperationException OnlyOneElementIsPermittedIn(
        IReadOnlyCollection<string> childElementTagNames, string parentElementTagName) =>
    ...
    public static InvalidOperationException CannotBeNestedInsideAnother(
        string tagName, IReadOnlyCollection<string> cannotBeNestedWithinTagNames) =>
            new($"A <{tagName}> cannot be nested inside another {JoinTagNamesWithConjunction(cannotBeNestedWithinTagNames)}.");
