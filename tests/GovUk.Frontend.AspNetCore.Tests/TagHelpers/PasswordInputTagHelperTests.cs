...
public class PasswordInputTagHelperTests : TagHelperTestBase<PasswordInputTagHelper>
{
    [Fact]
    public async Task ProcessAsync_InvokesComponentGeneratorWithExpectedOptions()
    {
        ...
        var disabled = true;
        var readOnly = true;
        var buttonClass = "additional-button-class";
    ...
    public async Task ProcessAsync_WithForAndExplicitHint_UsesSpecifiedHint()
    {
        ...
        var output = new TagHelperOutput(
            ...
            getChildContentAsync: (useCachedResult, encoder) =>
            {
                ...
                inputContext.SetHint([], new HtmlString(hintHtml), PasswordInputHintTagHelper.TagName);
