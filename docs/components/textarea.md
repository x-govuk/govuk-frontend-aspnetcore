<!-- Generated from src/GovUk.Frontend.AspNetCore.Docs/Templates/components/textarea.liquid -->
# Textarea

[GOV.UK Design System textarea component](https://design-system.service.gov.uk/components/textarea/)
...
| `described-by` | `string` | One or more element IDs to add to the `aria-describedby` attribute of the generated `textarea` element. |
