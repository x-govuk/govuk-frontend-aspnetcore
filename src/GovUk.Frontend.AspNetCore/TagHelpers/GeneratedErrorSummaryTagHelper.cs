...
public class GeneratedErrorSummaryTagHelper : TagHelper
{
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        var prependErrorSummary = PrependErrorSummary ??
            ((output.TagName?.Equals("form", StringComparison.OrdinalIgnoreCase) == true && generateErrorSummariesOptions.HasFlag(PrependToFormElements)) ||
            (output.TagName?.Equals("main", StringComparison.OrdinalIgnoreCase) == true && generateErrorSummariesOptions.HasFlag(PrependToMainElement)));
