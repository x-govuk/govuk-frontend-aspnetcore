...
public class ServiceNavigationNavTagHelperTests : TagHelperTestBase<ServiceNavigationNavTagHelper>
{
    ...
    public async Task ProcessAsync_SetsNavOnContext()
    {
        ...
        Assert.Equal(navStartSlotContent, serviceNavigationContext.Nav.NavigationStartSlot?.Html.ToHtmlString());
        Assert.Equal(navEndSlotContent, serviceNavigationContext.Nav.NavigationEndSlot?.Html.ToHtmlString());
    }
