...
public class PasswordInputBeforeInputTagHelperTests : TagHelperTestBase<PasswordInputBeforeInputTagHelper>
{
    [Fact]
    public async Task ProcessAsync_SetsBeforeInputOnContext()
    {
        ...
        var tagHelper = new PasswordInputBeforeInputTagHelper(new NullLogger<PasswordInputBeforeInputTagHelper>());
